...
--  end read only
--  begin read only
   function Wrap_Test_To_Time_e953f5_8a629f (Date: String)  return Time
   is
   begin
      begin
         pragma Assert
      ...
      declare
         Test_To_Time_e953f5_8a629f_Result : constant Time := GNATtest_Generated.GNATtest_Standard.AtomFeed.To_Time (Date);
      begin
         begin
            pragma Assert
              (True);
...
--  begin read only
   ...
   procedure Test_To_Time_e953f5_8a629f (Gnattest_T : in out Test) renames Test_To_Time_test_to_date;
--  id:2.2/e953f5f4ae1398fb/To_Time/1/0/test_to_date/
   procedure Test_To_Time_test_to_date (Gnattest_T : in out Test) is
      function To_Time (Date: String) return Time renames Wrap_Test_To_Time_e953f5_8a629f;
--  end read only
...
--  begin read only
   function Wrap_Test_To_HTTP_Date_2bd5b1_bcc90f (Date: Time)  return String
   is
   begin
      begin
         pragma Assert
      ...
      declare
         Test_To_HTTP_Date_2bd5b1_bcc90f_Result : constant String := GNATtest_Generated.GNATtest_Standard.AtomFeed.To_HTTP_Date (Date);
      begin
         begin
            pragma Assert
              (True);
...
--  begin read only
   ...
   procedure Test_To_HTTP_Date_2bd5b1_bcc90f (Gnattest_T : in out Test) renames Test_To_HTTP_Date_test_to_http_date;
--  id:2.2/2bd5b10ba8625102/To_HTTP_Date/1/0/test_to_http_date/
   procedure Test_To_HTTP_Date_test_to_http_date (Gnattest_T : in out Test) is
      function To_HTTP_Date (Date: Time) return String renames Wrap_Test_To_HTTP_Date_2bd5b1_bcc90f;
--  end read only
