...
package Config.Test_Data.Tests.TableTags_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Config.TableTags_Container.Test_Data (Test);
...
end Config.Test_Data.Tests.TableTags_Container.Test_Data;
